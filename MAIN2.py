...
def welcome():
    ...
    # speak("Teḍll me how may I help you")
    ...
    def Main(self):
        ...
        while True:
            ...
            if "information about" in self.query or "tell me" in self.query:    
                ...
                speak("Temperature of which city or country?")
                ...
                print("Launching youtube for you sir!")
                webbrowser.open("youtube.com")
                time.sleep(10)
 
            
            elif 'open dashboard' in self.query or 'dashboard' in self.query :
                print("Launching dashboard for you sir!")
                ...
                print("Launching google for you sir!")
                webbrowser.open("google.com")
                time.sleep(10)
                
                
            elif 'open vs code' in self.query or 'code' in self.query :
                print("Launching visual studio code for you sir!")
                ...
                print("Launching what's app for you sir!")
                ...
                print("Launching telegram for you sir!")
                ...
                print("Launching chrome for you sir!")
                ...
                print("Launching excel for you sir!")
                ...
                print("Launching powerpoint for you sir!")
                ...
                print("Launching word for you sir!")
                ...
                print('I was created by my AI master ganesh in 2022')
                ...
                print("Okay sir, closing the window")
